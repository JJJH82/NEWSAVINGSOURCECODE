...
RESOURCES += src/qt/saving.qrc src/qt/saving_locale.qrc

TRANSLATIONS += src/qt/locale/saving_bg.ts \
                src/qt/locale/saving_de.ts \
                src/qt/locale/saving_en.ts \
                src/qt/locale/saving_es.ts \
                src/qt/locale/saving_fi.ts \
                src/qt/locale/saving_fr.ts \
                src/qt/locale/saving_it.ts \
                src/qt/locale/saving_ja.ts \
                src/qt/locale/saving_pl.ts \
                src/qt/locale/saving_pt.ts \
                src/qt/locale/saving_ru.ts \
                src/qt/locale/saving_sk.ts \
                src/qt/locale/saving_sv.ts \
                src/qt/locale/saving_vi.ts \
                src/qt/locale/saving_zh_CN.ts \
                src/qt/locale/saving_zh_TW.ts
