...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Saving features */
        {"saving", "listmasternodes", &listmasternodes, true, true, false},
        {"saving", "getmasternodecount", &getmasternodecount, true, true, false},
        {"saving", "masternodeconnect", &masternodeconnect, true, true, false},
        {"saving", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"saving", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"saving", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"saving", "masternodecurrent", &masternodecurrent, true, true, false},
        {"saving", "masternodedebug", &masternodedebug, true, true, false},
        {"saving", "startmasternode", &startmasternode, true, true, false},
        {"saving", "createmasternodekey", &createmasternodekey, true, true, false},
        {"saving", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"saving", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"saving", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"saving", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"saving", "getmasternodescores", &getmasternodescores, true, true, false},
        {"saving", "preparebudget", &preparebudget, true, true, false},
        {"saving", "submitbudget", &submitbudget, true, true, false},
        {"saving", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"saving", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"saving", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"saving", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"saving", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"saving", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"saving", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"saving", "checkbudgets", &checkbudgets, true, true, false},
        {"saving", "mnsync", &mnsync, true, true, false},
        {"saving", "spork", &spork, true, true, false},
        {"saving", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsviseed", &getzsviseed, false, false, true},
        {"zerocoin", "setzsviseed", &setzsviseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsvi", &searchdzsvi, false, false, true},
        {"zerocoin", "dzsvistate", &dzsvistate, false, false, true},
...
{
    return "> saving-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17451/\n";
}
