...
extern UniValue DoZsviSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzsviseed(const UniValue& params, bool fHelp);
extern UniValue getzsviseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsvi(const UniValue& params, bool fHelp);
extern UniValue dzsvistate(const UniValue& params, bool fHelp);
