...
#ifndef Saving_ZSVITRACKER_H
#define Saving_ZSVITRACKER_H
...
public:
    CzSVITracker(std::string strWalletFile);
    ~CzSVITracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSVIWallet* zSVIWallet = NULL);
