...
#ifndef Saving_ZSVIWALLET_H
#define Saving_ZSVIWALLET_H
...
public:
    CzSVIWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSVI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSVI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
