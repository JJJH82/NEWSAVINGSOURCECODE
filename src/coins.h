...
/** 
    ...
    ****Note - for Saving we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of saving coming in to a transaction
