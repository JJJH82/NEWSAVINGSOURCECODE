...
/** Utility functions used by the Saving Qt UI.
 */
namespace GUIUtil
{
...
// Render Saving addresses in monospace font
...
// Parse "saving:" URI into recipient object, return true on successful parsing
