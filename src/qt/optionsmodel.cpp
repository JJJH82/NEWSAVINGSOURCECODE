...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SVI);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeSavingAmount"))
        SoftSetArg("-anonymizesavingamount", settings.value("nAnonymizeSavingAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in saving.cpp during shotdown to also remove the window positions
