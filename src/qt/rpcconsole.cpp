                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSVIPathCustom = GetArg("-zsvibackuppath", "");
    ...
    if(!strzSVIPathCustom.empty()) {
        ui->wallet_customzsvibackuppath->setText(QString::fromStdString(strzSVIPathCustom));
        ui->wallet_customzsvibackuppath_label->setVisible(true);
        ui->wallet_customzsvibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSVIPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Saving RPC console.") + "<br>" +
