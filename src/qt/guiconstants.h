...
/* Saving GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Saving"
#define QAPP_ORG_DOMAIN "saving.org"
#define QAPP_APP_NAME_DEFAULT "Saving-Qt"
#define QAPP_APP_NAME_TESTNET "Saving-Qt-testnet"
