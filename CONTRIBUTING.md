Contributing to Saving Core
============================

The Saving Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/saving-project/saving/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Saving Core project, and is not to be
confused with overall Saving Network Protocol consensus changes.

Whether a pull request is merged into Saving Core rests with the project merge
...
Patches that change Saving consensus rules are considerably more involved than
...
Where a patchset proposes to change the Saving consensus, it must have been
...
The project leader is the release manager for each Saving Core release.
