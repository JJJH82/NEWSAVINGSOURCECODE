...
from fake_stake.base_test import Saving_FakeStakeTest

class zSVIwrappedSerialsTest(Saving_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSVIs..." % DENOM_TO_USE)
